...
{
    Compress-Archive -LiteralPath distrib/gui/win-legacy/ps3-disc-dumper.exe -DestinationPath distrib/ps3-disc-dumper_win64_legacy_NEW.zip -CompressionLevel Optimal -Force
}
if (Test-Path -LiteralPath distrib/gui/win/ps3-disc-dumper.exe)
{
    # Remove-Item -LiteralPath distrib/gui/win/*.pdb
    Compress-Archive -LiteralPath distrib/gui/win/ps3-disc-dumper.exe -DestinationPath distrib/ps3-disc-dumper_win64_NEW.zip -CompressionLevel Optimal -Force
}
if (Test-Path -LiteralPath distrib/cli/lin/ps3-disc-dumper)
{
    Compress-Archive -LiteralPath distrib/cli/lin/ps3-disc-dumper -DestinationPath distrib/ps3-disc-dumper_lin64_legacy_NEW.zip -CompressionLevel Optimal -Force
}
if (Test-Path -LiteralPath distrib/gui/lin/ps3-disc-dumper)
{
    Compress-Archive -LiteralPath distrib/gui/lin/ps3-disc-dumper -DestinationPath distrib/ps3-disc-dumper_lin64_NEW.zip -CompressionLevel Optimal -Force
}
