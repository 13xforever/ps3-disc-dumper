...
if ($IsWindows -or ($PSVersionTable.Platform -eq 'Win32NT'))
{
    ...
    dotnet publish -v:q -r win-x64 -f net9.0-windows --self-contained -c Release -o distrib/gui/win/ UI.Avalonia/UI.Avalonia.csproj /p:PublishTrimmed=$trim /p:PublishSingleFile=True
}

Write-Host 'Building Linux binary...' -ForegroundColor Cyan
dotnet publish -v:q -r linux-x64 -f net9.0 --self-contained -c Linux -o distrib/gui/lin/ UI.Avalonia/UI.Avalonia.csproj /p:PublishTrimmed=$trim /p:PublishSingleFile=True
